...
static int s4FM50AF_ReadReg(unsigned short * a_pu2Result)
{
    ...
    FM50AFDB("[liwenyuan]s4FM50AF_ReadReg!i4RetValue=%d\n",i4RetValue);    
    ...
    *a_pu2Result = (((u16)pBuff[0]) << 4) + (pBuff[1] >> 4);
    FM50AFDB("[liwenyuan]s4FM50AF_ReadReg!a_pu2Result=%d\n",*a_pu2Result);    
...
static int s4FM50AF_WriteReg(u16 a_u2Data)
{
    ...
    FM50AFDB("[liwenyuan]s4FM50AF_WriteReg !a_u2Data=%d\n",a_u2Data);    
...
char puSendCmd2[2]={(char)(0x9C),(char)(0xAA)};//B point=170d 
...
char puSendCmd4[2]={(char)(0x8C),(char)(0x63)};//105Hz,Fastest mode
    ...
    FM50AFDB("[FM50AF] [liwenyuan]FM50AF_Open - i4RetValue=%d,line=%d\n",i4RetValue,__LINE__);
